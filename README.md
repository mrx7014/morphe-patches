...
<!-- PATCHES_START -->
> **[v1.41.0](https://github.com/mrx7014/morphe-patches/releases/tag/v1.41.0)**&nbsp;&nbsp;•&nbsp;&nbsp;`main`&nbsp;&nbsp;•&nbsp;&nbsp;145 patches total
<details>
...
See the [Patches template](https://github.com/mrx7014/morphe-patches) for more information.

## 📜 License

MRX7014 Patches are licensed under the [GNU General Public License v3.0](LICENSE), with additional conditions under GPLv3 Section 7:
